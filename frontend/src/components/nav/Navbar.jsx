...
const Navbar = () => {
  ...
  const NavProps = isHighPerformance ? {
    ...
    className: `fixed top-0 left-0 right-0 z-50 px-2 sm:px-4 py-2 sm:py-4 transition-all duration-300 ${
  ...
  return (
    <NavWrapper {...NavProps} ref={navRef}>
      <div className="max-w-4xl mx-auto">
        <div className={`glass-card py-2 sm:py-3 px-3 sm:px-4 md:px-6 transition-all duration-300 ${
          scrolled ? 'shadow-lg' : ''
        }`}>
