...
export const Content = () => {
  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] relative px-3 sm:px-4 md:px-8 flex items-center justify-center">
      <div className="w-full max-w-4xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 py-8 md:py-0">
        <div className="order-2 md:order-1 w-full md:w-2/3 relative z-10 text-center md:text-left">
          <div className={`mb-6 md:mb-8 ${isHighPerformance ? 'slide-up' : ''}`}>
            ...
            <h1 
              ...
              className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 md:mb-6 text-gray-200"
            >
          ...
          <p
            className={`text-base sm:text-lg md:text-2xl font-semibold text-cyan-400 max-w-2xl mx-auto md:mx-0 ${
              isHighPerformance ? 'slide-in-left delay-300' : ''
            }`}
            style={{ fontFamily: "ChocoCooky" }}
          >
