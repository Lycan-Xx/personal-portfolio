  ...
  return (
    ...
    >
      <div className="w-full max-w-[86rem] mx-auto relative">
        ...
        <div className="absolute inset-0 bg-black/40 backdrop-blur-xl rounded-none md:rounded-3xl shadow-lg shadow-cyan-400/5 border border-secondary"></div>
        ...
        <div className="relative p-6 md:p-10 z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="glass-card p-8 bg-gray-800/40 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-secondary hover:border-secondary transition-all duration-300"
            >
            ...
            >
              ...
              >
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-secondary rounded-lg text-white focus:outline-none focus:border-cyan-400 transition-colors"
                />
                <input
                  type="email"
                  name="email"
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-secondary rounded-lg text-white focus:outline-none focus:border-cyan-400 transition-colors resize-none"
                />
                <motion.button
                  type="submit"
                  ...
                  bg-cyan-400/20 hover:bg-cyan-400/30 border border-secondary hover:border-secondary transition-all duration-300
