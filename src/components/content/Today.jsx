...
export const Today = () => {
	...
	const fullGreeting = useMemo(() => {
		return `Welcome, fellow coder! You've booted into the realm of ${timeOfDayMessage}.`;
	}, [timeOfDayMessage]);
	...
	return (
		<div className="glass-card w-[400px] p-6 mx-auto opacity-0 translate-y-5 animate-fade-in-up">
			<div className="space-y-4">
				...
				<div className="mt-4 text-lg font-medium font-mono text-gray-300 h-[80px] overflow-hidden">
					{typedText}
